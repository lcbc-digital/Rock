                    ...
                    <Rock:PanelWidget ID="wpGeneral" runat="server" Title="General">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <Rock:RockDropDownList ID="ddlGroupStatusDefinedType" runat="server" Label="Group Status Defined Type" Help="Select the defined type to use when setting the group's status. Leave this blank if you don't want groups to prompt for group status." />
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-xs-6">
