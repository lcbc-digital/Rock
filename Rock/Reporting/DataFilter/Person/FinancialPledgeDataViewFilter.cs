...
{
    /// <summary>
    ///     A Data Filter to select Donor by their Transactions from a Financial Pledge View.
    /// </summary>
    ...
    public class FinancialPledgeDataViewFilter : DataFilterComponent
    {
        #region Settings
        ...
        {
            return "Financial Pledge Data View";
        }
...
function() {
  ...
  var FinancialPledge = $('.rock-drop-down-list,select:last', $content).find(':selected').text();
  var result = 'FinancialPledge';
  if (FinancialPledge) {
     result = result + ' type ""' + FinancialPledge + "";
  }  
...
";
        ...
        public override string FormatSelection( Type entityType, string selection )
        {
            ...
            string result = "Connected to Financial Pledge";
        ...
        public override Control[] CreateChildControls( Type entityType, FilterField filterControl )
        {
            ...
            int entityTypeId = CacheEntityType.Get( typeof( Model.FinancialPledge ) ).Id;
