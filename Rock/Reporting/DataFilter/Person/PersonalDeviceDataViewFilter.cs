...
namespace Rock.Reporting.DataFilter.Person
{
    ...
    public class PersonalDeviceDataViewFilter : DataFilterComponent
    {
        #region Settings
        ...
        {
            return "Personal Device Data View";
        }
...
function() {
  ...
  var result = 'Personal Device record is in filter: ' + dataViewName;
  return result;
}
";
        }
