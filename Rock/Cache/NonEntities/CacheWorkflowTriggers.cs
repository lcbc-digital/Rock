...
namespace Rock.Cache
{
	...
	public class CacheWorkflowTriggers : ItemCache<CacheWorkflowTriggers>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static CacheWorkflowTriggers Get()
        {
            return Get( null );
        }
        ...
        /// <returns></returns>
        public static CacheWorkflowTriggers Get( RockContext rockContext )
        {
        ...
        private static CacheWorkflowTriggers QueryDb( RockContext rockContext )
        {
            if ( rockContext != null )
            {
        ...
        private static CacheWorkflowTriggers QueryDbWithContext( RockContext rockContext )
        {
            ...
            var value = new CacheWorkflowTriggers { EntityTriggers = workflowTriggers };
            return value;
        }
