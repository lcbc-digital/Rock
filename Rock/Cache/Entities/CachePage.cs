...
namespace Rock.Cache
{
    ...
    [Serializable]
    [DataContract]
    public class CachePage : ModelCache<CachePage, Page>
    {
        ...
        /// </summary>
        public CacheLayout Layout => CacheLayout.Get( LayoutId );
        ...
        /// <summary>
        /// Gets a List of child <see cref="CachePage" /> objects.
        /// </summary>
        /// <returns></returns>
        public List<CachePage> GetPages( RockContext rockContext )
        {
        ...
        /// <summary>
        /// Gets a List of all the <see cref="CacheBlock"/> objects configured for the page and the page's layout.
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public List<CachePage> GetPageHierarchy()
        {
            var pages = new List<CachePage> { this };
        ...
        /// <returns></returns>
        public XDocument MenuXml( int levelsDeep, Person person, RockContext rockContext, CachePage currentPage = null, Dictionary<string, string> parameters = null, NameValueCollection queryString = null )
        {
        ...
        /// <param name="queryString">The query string.</param>
        /// <returns></returns>
        private XElement MenuXmlElement( int levelsDeep, Person person, RockContext rockContext, CachePage currentPage = null, Dictionary<string, string> parameters = null, NameValueCollection queryString = null )
        {
